...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--postfix', type=str, dest = 'postfix', default = '_license_plate',
        help=''
    )

    # parser.add_argument(
    #     '--blur_path', type=str, default='/home/ec2-user/mila_license_detection/Data/Source_Images/Blur_License/',
    #     help='Blur Path'
    # )
