...
arglist = [['input_path',input_folder],['classes',classes_file],['output',output_folder],['yolo_model',model_weights],['box_file',result_file],['anchors',anchors], ['file_types','.jpg .jpeg .png']]
