...
def ChangeToOtherMachine(filelist,repo='mila_license_detection/Data/Source_Images/',remote_machine =''):
    '''
    ...
    'C:/Users/Ananth/TrainYourOwnYOLO/Data/Street_View_Images/vulnerable/test.jpg'
    ...
    for entry in new_list:
        new_list1.append(('/').join(entry.split('/')[0:4] + entry.split('/')[6:]))
    print(new_list1)
    return new_list1